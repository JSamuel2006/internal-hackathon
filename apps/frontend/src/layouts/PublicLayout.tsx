        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 mb-10 pb-10 border-b border-slate-200">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-slate-600 font-medium">
              ...
              <li><a href="/#services" className="hover:text-teal-600 transition-colors">Healthcare Services</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-slate-600 font-medium">
              <li><Link to="/login" className="hover:text-teal-600 transition-colors">Citizen Health Portal</Link></li>
              <li><Link to="/login" className="hover:text-teal-600 transition-colors">ASHA Field Worker Portal</Link></li>
              <li><Link to="/login" className="hover:text-teal-600 transition-colors">Doctor Clinical Command</Link></li>
              <li><Link to="/login" className="hover:text-teal-600 transition-colors">Public Health Surveillance</Link></li>
            </ul>
          </div>
