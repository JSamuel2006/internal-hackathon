    ...
    <div className="min-h-screen flex flex-col bg-white text-slate-800 font-sans selection:bg-teal-500 selection:text-white">
      ...
      <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-100 shadow-sm px-4 md:px-8 py-3.5 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          <Link
            to="/login"
            className="flex items-center gap-2 px-5 py-2.5 rounded-2xl text-xs font-semibold text-slate-700 hover:text-teal-700 bg-white hover:bg-slate-50 border border-slate-200 transition-all cursor-pointer"
          >
          ...
          <Link
            to="/signup"
            className="flex items-center gap-2 px-5.5 py-2.5 rounded-2xl text-xs font-bold bg-teal-600 hover:bg-teal-700 text-white shadow-sm transition-all cursor-pointer"
          >
