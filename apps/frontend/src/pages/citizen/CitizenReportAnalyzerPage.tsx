  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto px-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-xl font-bold tracking-tight text-slate-100">AI Medical Report Analyzer</h2>
          <p className="text-xs text-slate-400 mt-0.5">National health surveillance compliant diagnostic report engine</p>
        </div>
      </div>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="glass-panel p-5 rounded-2xl border border-slate-900">
              ...
              <span className="text-2xl font-bold text-slate-200 font-mono">{history.length}</span>
              <p className="text-[10px] text-slate-400 mt-1">Processed reports</p>
            </div>
            <div className="glass-panel p-5 rounded-2xl border border-slate-900">
              ...
              <p className="text-[10px] text-slate-400 mt-1">From {history[0]?.reportType || 'No reports yet'}</p>
            </div>
            <div className="glass-panel p-5 rounded-2xl border border-slate-900">
              ...
              <p className="text-[10px] text-slate-400 mt-1">Suggested Consultant</p>
            </div>
            <div className="glass-panel p-5 rounded-2xl border border-slate-900">
              ...
              <p className="text-[10px] text-slate-400 mt-1">Category: <strong className="text-slate-350">{overallHealth.category}</strong></p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="glass-panel p-6 rounded-2xl border border-slate-900 space-y-4">
                ...
                {history[0] && (
                  <div className="grid grid-cols-2 gap-4 text-xs font-mono bg-slate-950/60 p-3.5 rounded-xl border border-slate-900">
                    <div>
                  ...
                  {history.length > 0 && history[0].riskLevel === 'High' ? (
                    <>
                      <div className="p-3 bg-rose-500/5 border border-rose-500/10 rounded-xl space-y-1">
                        ...
                        <p className="text-slate-400">Recheck Lipid profile panel within 12 weeks to assess cholesterol changes.</p>
                      </div>
                      <div className="p-3 bg-amber-500/5 border border-amber-500/10 rounded-xl space-y-1">
                        ...
                        <p className="text-slate-400">Schedule consultation with a {history[0].specialistRecommended} for cardiovascular check.</p>
                      </div>
                    </>
                  ) : (
                ...
                <div className="space-y-3 text-xs">
                  {loadingActivities ? (
                    ...
                    recentActivities.map((act) => {
                      ...
                      return (
                        <div key={act.id} className="flex items-center justify-between p-2.5 rounded-lg bg-slate-950/60 border border-slate-900">
                          <div className="flex items-center gap-2.5 min-w-0">
                            ...
                            <div className="min-w-0 flex-1">
                              <span className="font-bold text-slate-300 block truncate">{act.title}</span>
      ...
      {activeTab === 'upload' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          {/* Upload panel (4 cols) */}
          <div className="lg:col-span-4 glass-panel p-5 rounded-2xl border border-slate-900 space-y-5 self-start">
            <form onSubmit={handleAnalyze} className="space-y-6">
              <div
                ...
                onDrop={handleDrop}
                className={`border-2 border-dashed border-slate-800 rounded-xl p-5 text-center hover:border-rose-500/30 transition-all relative flex flex-col justify-center items-center min-h-[220px] ${
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-slate-300">Drag & Drop Reports</p>
              ...
              <div className="bg-slate-950/60 p-3 rounded-xl border border-slate-900 space-y-2">
                <button
                  ...
                  className="w-full py-2 bg-slate-900 border border-slate-800 hover:bg-rose-500/10 hover:text-rose-400 text-slate-300 font-bold rounded-lg text-xs font-mono uppercase transition-all flex items-center justify-center gap-1.5"
                >
                ...
                {cameraActive && (
                  <div className="space-y-3">
                    <div className="overflow-hidden border border-slate-800 rounded-lg aspect-video bg-black relative">
              ...
              {fileList.length > 0 && (
                <div className="space-y-2">
                  ...
                  <div className="space-y-1.5 max-h-32 overflow-y-auto">
                    {fileList.map((f, i) => (
                      <div key={i} className="bg-slate-900/60 p-2.5 rounded border border-slate-850 text-xs flex justify-between items-center">
          ...
          <div className="lg:col-span-8 space-y-6">
            {previewUrl && (
              <div className="glass-panel p-4 rounded-2xl border border-slate-900 space-y-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className={`px-2 py-0.5 border text-[10px] font-mono rounded ${
                        splitScreen ? 'bg-rose-500/20 border-rose-500/30 text-rose-455' : 'bg-slate-950 border-slate-800 text-slate-400'
                      }`}
                    >
                      Split Compare
                    </button>
                ...
                <div className={`grid ${splitScreen ? 'grid-cols-2' : 'grid-cols-1'} gap-4`}>
                  <div className="overflow-hidden border border-slate-850 rounded-lg h-80 flex justify-center bg-slate-950">
                    <img
                      src={previewUrl}
                      alt="Current Report"
                  ...
                  {splitScreen && (
                    <div className="overflow-hidden border border-slate-850 rounded-lg h-80 flex flex-col justify-center items-center bg-slate-950 text-slate-500 p-4 text-center">
                      <span className="text-xs font-mono font-bold block mb-1">Previous Report Reference</span>
                      <span className="text-[10px] text-slate-400">Lipid Profile (2026-05-15)</span>
                    </div>
                  )}
                </div>
              </div>
            ...
            {result ? (
                ...
                <div className="glass-panel p-5 rounded-2xl border border-slate-900 space-y-4">
                  <div className="flex justify-between items-center border-b border-slate-850 pb-3">
                    <div>
                      ...
                      <h3 className="text-lg font-bold text-slate-100 mt-1.5">{result.reportType || 'Complete Blood Count (CBC)'}</h3>
                    ...
                    <button
                      ...
                      className="p-2 bg-slate-900 border border-slate-800 rounded-lg text-slate-400 hover:text-slate-200"
                    >
                  ...
                  <div className="glass-panel p-5 rounded-2xl border border-slate-900 space-y-4">
                    ...
                    <div className="space-y-3.5">
                      {result.abnormalValues.map((val: any, idx: number) => (
                        <div key={idx} className="p-3.5 bg-slate-950/50 rounded-xl border border-slate-900 space-y-1.5">
                          <div className="flex justify-between items-start">
                            <div>
                              <span className="font-bold text-slate-200">{val.parameter}</span>
                          ...
                          <div className="flex gap-4 text-xs">
                            <div>
                              ...
                              <p className="font-mono text-slate-200 font-bold">{val.value}</p>
                            </div>
                            <div className="flex-1">
                              <span className="text-slate-500 text-[10px]">Clinical Interpretation</span>
                              <p className="text-slate-400 leading-relaxed">{val.explanation}</p>
                            </div>
                          </div>
                        </div>
                      ))}
              ...
              <div className="h-48 flex flex-col items-center justify-center text-center p-8 text-slate-500 glass-panel rounded-2xl border border-slate-900">
      ...
      {activeTab === 'comparison' && (
        <div className="space-y-6">
          <div className="glass-panel p-5 rounded-2xl border border-slate-900 space-y-4">
            ...
            <div className="flex gap-3 items-center bg-slate-900/60 p-3 rounded-xl border border-slate-850 text-xs">
              ...
              <select
                ...
                className="bg-slate-950 border border-slate-800 rounded p-1 text-slate-355 flex-1 max-w-xs"
              >
            ...
            {compareResult.length > 0 ? (
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 p-3 bg-slate-950/60 rounded border border-slate-900 font-mono text-[10px] uppercase text-slate-500">
                  <div>Parameter</div>
                ...
                {compareResult.map((c, i) => (
                  <div key={i} className="grid grid-cols-1 md:grid-cols-4 gap-4 p-3 bg-slate-900/40 rounded border border-slate-850 text-xs items-center">
                    <div className="font-bold text-slate-200">{c.parameter}</div>
                    <div className="text-center text-slate-400">{c.previous}</div>
                    <div className="text-center text-slate-200 font-bold">{c.current}</div>
                    <div className={`text-right font-mono font-bold flex justify-end items-center gap-1 ${
                      ...
                      <span className="px-1.5 py-0.5 bg-slate-950/80 rounded border border-slate-900">{c.status}</span>
                    </div>
                  </div>
                ))}
              </div>
      ...
      {activeTab === 'timeline' && (
        <div className="space-y-6">
          <div className="flex gap-4 items-center bg-slate-900/60 p-3 rounded-xl border border-slate-850 text-xs">
            <span className="font-mono text-slate-500 uppercase">Filters:</span>
            <div className="flex gap-2">
              <select
                value={filterYear}
                onChange={e => setFilterYear(e.target.value)}
                className="bg-slate-950 border border-slate-800 rounded p-1 text-slate-355 font-mono"
              >
                <option>All</option>
                <option>2026</option>
              </select>
              <select
                ...
                className="bg-slate-950 border border-slate-800 rounded p-1 text-slate-355"
              >
                <option>All</option>
          ...
          <div className="space-y-6 relative border-l border-slate-850 ml-4 pl-6">
            {history
                    ...
                    <div className="glass-panel p-5 rounded-2xl border border-slate-900 space-y-3">
                      <div className="flex justify-between items-center">
                        <div>
                          ...
                          <h4 className="font-bold text-slate-200">{h.reportType}</h4>
                      ...
                      <div className="text-xs text-slate-400 space-y-1.5">
                        <p><strong className="text-slate-300">Abnormal Readings:</strong> {abnormalList.map((v: any) => `${v.parameter} (${v.value})`).join(', ') || 'None detected'}</p>
                        <p><strong className="text-slate-300">Specialist Consultant:</strong> {h.specialistRecommended}</p>
                      </div>
                    </div>
                  </div>
                );
          ...
          <div className="glass-panel p-6 rounded-2xl border border-slate-900 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <button
                ...
                className="flex flex-col items-center justify-center p-5 bg-slate-950/60 hover:bg-rose-500/10 border border-slate-900 rounded-xl space-y-2 transition-all group"
              >
                <Printer className="w-8 h-8 text-rose-455 group-hover:scale-110 transition-transform" />
                <span className="text-xs font-bold text-slate-200">Patient PDF Summary</span>
              ...
              >
                ...
                <span className="text-xs font-bold text-slate-200">Timeline Data (CSV)</span>
              ...
              >
                ...
                <span className="text-xs font-bold text-slate-200">AI Schema Logs (JSON)</span>
