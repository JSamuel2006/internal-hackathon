  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {SCHEMES.map((sch) => (
          <div key={sch.id} className="bg-white border border-slate-200 shadow-sm p-6 rounded-2xl border border-slate-200 flex flex-col justify-between min-h-[360px]">
            <div>
              <div className="flex items-center justify-between mb-3">
                <h3 className="font-bold text-slate-800 text-sm">{sch.name}</h3>
              ...
              <p className="text-xs text-slate-600 leading-relaxed mb-4">{sch.description}</p>
