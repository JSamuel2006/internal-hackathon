    ...
    <div className="space-y-8 max-w-7xl mx-auto px-4">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-slate-900 pb-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">Simulate lifestyle scenarios and immediately calculate future disease probability differences</p>
          </div>
        </div>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-semibold uppercase tracking-wider transition-all ${
                activeSubTab === tab
                  ...
                  : 'border border-slate-850 bg-slate-900/40 text-slate-400 hover:text-white'
              }`}
            >
      ...
      {activeSubTab === 'twin' && (
        <div className="space-y-8 animate-fade-in">
          ...
          {historyList.length > 0 && (
            <div className="glass-panel p-4 rounded-2xl border border-slate-900 flex flex-col md:flex-row items-start md:items-center gap-4 bg-slate-950/40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="glass-panel p-5 rounded-2xl border border-slate-900 bg-gradient-to-br from-slate-900 to-slate-950 flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="my-3 flex items-baseline gap-2">
                <span className="text-4xl font-extrabold text-slate-200 font-mono tracking-tight">{twinData?.overallHealthScore || 85}</span>
            ...
            <div className="glass-panel p-5 rounded-2xl border border-slate-900 flex flex-col justify-between">
              ...
              <p className="text-[9px] text-slate-400 font-mono">Based on active clinical records</p>
            </div>
            ...
            <div className="glass-panel p-5 rounded-2xl border border-slate-900 flex flex-col justify-between">
              ...
              <p className="text-[9px] text-slate-400 font-mono truncate">{twinData?.confidenceReason || 'Dataset completeness verified'}</p>
            </div>
            ...
            <div className="glass-panel p-5 rounded-2xl border border-slate-900 flex flex-col justify-between">
              ...
              <p className="text-[9px] text-slate-400 font-mono">Simulated target: 100%</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 space-y-6">
              <div className="glass-panel p-6 rounded-2xl border border-slate-900 space-y-5">
                <h3 className="text-sm font-bold text-slate-200 uppercase tracking-wider border-b border-slate-850 pb-3 flex items-center gap-2">
                    ...
                    return (
                      <div key={idx} className="p-4 bg-slate-950/60 border border-slate-900 rounded-xl space-y-2 flex flex-col justify-between">
                        <div className="flex items-center justify-between">
                          <span className="font-bold text-slate-200 text-xs font-mono">{sys.name}</span>
                        ...
                        <div className="flex items-baseline gap-2">
                          <span className="text-lg font-bold text-slate-300 font-mono">{sys.score}</span>
                          <span className="text-[10px] text-slate-500">score</span>
                          <span className="text-[10px] text-rose-455 ml-auto font-mono">{sys.trend}</span>
                        </div>
                        <p className="text-[10px] text-slate-400 leading-relaxed italic mt-1">{sys.recommendation}</p>
                      </div>
                    );
                  })}
                </div>
                      ...
                      <div key={idx} className="bg-slate-950/60 border border-slate-900 rounded-2xl p-5 space-y-4">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                          <div>
                            ...
                            <p className="text-[10px] text-slate-400 font-mono mt-1">Trend: <strong className="text-amber-500">{pred.historicalTrend}</strong></p>
                          </div>
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <button
                              ...
                              className="p-1.5 hover:bg-slate-900 border border-slate-850 rounded-lg text-slate-400"
                            >
                        ...
                        {isExpanded && (
                          <div className="border-t border-slate-900 pt-4 grid grid-cols-1 md:grid-cols-2 gap-5 text-xs animate-slide-down">
                            <div className="space-y-3">
                              <div>
                                <span className="text-slate-500 text-[10px] uppercase font-mono block font-bold mb-1">Clinical Reasoning</span>
                                <div className="text-slate-350 leading-relaxed font-mono whitespace-pre-line bg-slate-950 p-3 rounded-lg border border-slate-900">
                                  {pred.reasoning}
                                </div>
                              </div>
                              <div>
                                <span className="text-slate-500 text-[10px] uppercase font-mono block font-bold mb-1">Evidence Used</span>
                                <p className="text-slate-400 font-mono">{pred.evidenceUsed?.join(', ')}</p>
                              </div>
                            </div>
                            <div className="space-y-3">
                              <div>
            ...
            <div className="lg:col-span-4 space-y-6">
              <div className="glass-panel p-5 rounded-2xl border border-slate-900 bg-gradient-to-b from-slate-900 to-slate-950 space-y-4">
                <h3 className="text-xs font-bold text-slate-350 uppercase tracking-wider border-b border-slate-850 pb-2 flex items-center gap-1.5">
                ...
                <div className="text-[9px] text-slate-500 italic border-t border-slate-850 pt-2 text-center">
      ...
      {activeSubTab === 'simulator' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 animate-fade-in">
          ...
          <div className="lg:col-span-4 glass-panel p-5 rounded-2xl border border-slate-900 space-y-6 self-start">
            <h3 className="text-xs font-bold text-slate-355 uppercase tracking-wider border-b border-slate-850 pb-2 flex items-center gap-2">
            ...
            <div className="space-y-4 text-xs font-mono">
              ...
              <div className="space-y-1">
                <div className="flex justify-between">
                  <span className="text-slate-400">Water Intake (Liters)</span>
              ...
              <div className="space-y-1">
                <div className="flex justify-between">
                  <span className="text-slate-400">Blood Sugar (mg/dL)</span>
            ...
            {simResult && (
              <div className="border-t border-slate-900 pt-4 space-y-3">
                ...
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-850 rounded-xl p-2.5 text-slate-200 text-xs focus:outline-none"
                />
                <button
            ...
            {savedSims.length > 0 && (
              <div className="border-t border-slate-900 pt-4 space-y-2">
                ...
                <div className="space-y-1.5 max-h-36 overflow-y-auto">
                  {savedSims.map((sim) => (
                    <div key={sim.id} className="bg-slate-900 p-2.5 rounded border border-slate-850 flex justify-between items-center text-xs">
                      <button
                        onClick={() => loadSavedSimulation(sim)}
                        className="text-left font-mono truncate text-slate-300 hover:text-rose-400 max-w-[180px]"
                      >
                        {sim.name}
                      </button>
                      <button
              ...
              <div className="space-y-6 animate-fade-in">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="glass-panel p-5 rounded-2xl border border-slate-900 flex flex-col justify-between">
                    ...
                    <span className="text-3xl font-extrabold text-slate-400 font-mono my-2">{twinData?.overallHealthScore || 85}%</span>
                  </div>
                  <div className="glass-panel p-5 rounded-2xl border border-slate-900 bg-gradient-to-br from-rose-500/5 to-amber-500/5 flex flex-col justify-between relative overflow-hidden">
                ...
                <div className="glass-panel p-5 rounded-2xl border border-slate-900 space-y-4">
                  <h4 className="text-xs font-bold text-slate-350 uppercase tracking-wider border-b border-slate-850 pb-2 flex items-center gap-1.5">
                ...
                <div className="glass-panel p-5 rounded-2xl border border-slate-900 space-y-4">
                  ...
                  <div className="space-y-2">
                    {simResult.diseaseRisks?.map((risk: any, i: number) => {
                      ...
                      return (
                        <div key={i} className="flex justify-between items-center bg-slate-950/60 p-3 rounded border border-slate-900 text-xs">
                          <span className="font-bold text-slate-300 font-mono">{risk.name}</span>
                          <div className="flex items-center gap-3">
                            <span className="text-slate-400 font-mono">{risk.simulatedProbability}% risk</span>
                ...
                <div className="glass-panel p-6 rounded-2xl border border-slate-900 space-y-4">
                  <h3 className="text-xs font-bold text-slate-355 uppercase tracking-wider border-b border-slate-850 pb-2">
                    Body System Impact Details
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {simResult.systemImpact?.map((sys: any, idx: number) => (
                      <div key={idx} className="p-4 bg-slate-950/60 border border-slate-900 rounded-xl space-y-1">
                        <div className="flex justify-between items-center">
                          <span className="font-bold text-slate-200 text-xs font-mono">{sys.name}</span>
                          <span className="text-sm font-bold text-teal-400 font-mono">{sys.simulatedScore}</span>
                        </div>
                        <p className="text-[10px] text-slate-400 leading-relaxed">{sys.reason}</p>
                      </div>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="glass-panel p-5 rounded-2xl border border-slate-900 space-y-3">
                    ...
                    <div className="space-y-2 text-xs">
                      {simResult.lifestyleCoachActionPlan.map((act: any, i: number) => (
                        <div key={i} className="p-2.5 bg-slate-950/60 rounded border border-slate-900 flex justify-between">
                          <div>
                            <strong className="text-teal-400 block font-mono uppercase text-[9px]">{act.action}</strong>
                            <p className="text-slate-400 mt-0.5">{act.reason}</p>
                          </div>
                  ...
                  <div className="glass-panel p-5 rounded-2xl border border-slate-900 space-y-3">
                    ...
                    <div className="space-y-2 text-xs">
                      {simResult.healthJourneyTimeline.map((mile: any, i: number) => (
                        <div key={i} className="flex justify-between items-center bg-slate-950/60 p-2.5 rounded border border-slate-900 font-mono">
                          <div>
                            <span className="font-bold text-slate-300 block">{mile.milestone}</span>
      ...
      {activeSubTab === 'compare' && (
        <div className="glass-panel p-6 rounded-2xl border border-slate-900 space-y-6 animate-fade-in">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-slate-950/40 p-4 rounded-xl border border-slate-900 text-xs">
            <div className="space-y-2">
          ...
          {compareTwinA && compareTwinB ? (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 text-xs">
              <div className="space-y-4 p-5 bg-slate-950/40 rounded-xl border border-slate-900">
                ...
                <div className="mt-3 flex justify-between items-center border-b border-slate-900 pb-2">
                  <span className="text-slate-400 font-bold uppercase">Simulated Overall Score</span>
                  <span className="text-lg font-bold font-mono text-slate-205">{compareTwinA.simulatedOverallScore}%</span>
                </div>
                <div className="flex justify-between items-center border-b border-slate-900 pb-2">
                  <span className="text-slate-400 font-bold uppercase">Lifestyle Score</span>
                  <span className="font-bold text-teal-400 font-mono">{compareTwinA.simulatedLifestyleScore}%</span>
                </div>
              </div>

              <div className="space-y-4 p-5 bg-slate-950/40 rounded-xl border border-slate-900">
                <span className="px-2.5 py-0.5 bg-slate-900 text-slate-400 border border-slate-850 text-[9px] font-mono rounded font-bold uppercase">SCENARIO B</span>
                <div className="mt-3 flex justify-between items-center border-b border-slate-900 pb-2">
                  <span className="text-slate-400 font-bold uppercase">Simulated Overall Score</span>
      ...
      {activeSubTab === 'profile' && (
        <div className="glass-panel p-6 rounded-2xl border border-slate-900 space-y-6">
          ...
          <form onSubmit={handleProfileSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-xs text-slate-400 block font-semibold">Age</label>
              <input
                type="number"
                value={profile.age}
                onChange={e => setProfile({ ...profile, age: Number(e.target.value) })}
                className="w-full bg-slate-950 border border-slate-850 rounded-xl p-3 text-slate-200 text-xs focus:border-rose-500/40 focus:outline-none transition-colors"
                required
              />
            </div>
            <div className="space-y-2">
              <label className="text-xs text-slate-400 block font-semibold">Gender</label>
              <select
            ...
            <div className="space-y-2">
              <label className="text-xs text-slate-400 block font-semibold">BMI</label>
              <input
                type="number"
                step="0.1"
                value={profile.bmi}
            ...
            <div className="space-y-2">
              <label className="text-xs text-slate-400 block font-semibold">Allergies</label>
              <input
                type="text"
            ...
            <div className="space-y-2 md:col-span-2">
              <label className="text-xs text-slate-400 block font-semibold">Existing Diseases / Clinical Diagnoses</label>
              <input
                type="text"
            ...
            <div className="space-y-2 md:col-span-2">
              <label className="text-xs text-slate-400 block font-semibold">Family Medical History</label>
              <textarea
                value={profile.familyHistory}
                onChange={e => setProfile({ ...profile, familyHistory: e.target.value })}
                className="w-full bg-slate-950 border border-slate-850 rounded-xl p-3 text-slate-200 text-xs focus:border-rose-500/40 focus:outline-none transition-colors h-20 resize-none"
              />
            </div>
            <div className="space-y-2 md:col-span-2">
              <label className="text-xs text-slate-400 block font-semibold">Lifestyle & Activity Level</label>
              <input
                type="text"
            ...
            <div className="space-y-2 md:col-span-2">
              <label className="text-xs text-slate-400 block font-semibold">Vaccination Record / History</label>
              <input
                type="text"
