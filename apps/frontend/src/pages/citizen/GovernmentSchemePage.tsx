  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto px-4 font-mono text-xs text-slate-350">
      <div className="border-b border-slate-900 pb-4">
        <h2 className="text-xl font-bold text-slate-100 uppercase tracking-wider">Government Health Scheme Navigator</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        <form onSubmit={checkEligibility} className="md:col-span-5 bg-slate-950 p-6 rounded-2xl border border-slate-900 space-y-4">
