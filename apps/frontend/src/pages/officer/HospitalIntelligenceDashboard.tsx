    ...
    <div className="space-y-6 max-w-7xl mx-auto px-4 font-mono text-xs text-slate-300">
      <div className="flex justify-between items-center border-b border-slate-900 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-sm font-bold text-slate-100 uppercase">Hospital Occupancy & Bed Intelligence</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
        <div className="glass-panel p-4 rounded-xl border border-slate-900">
          ...
          <strong className="text-xl text-slate-100 font-bold block mt-1">1,240 / 1,500</strong>
        </div>
        <div className="glass-panel p-4 rounded-xl border border-slate-900">
      ...
      <div className="glass-panel p-5 rounded-xl border border-slate-900 space-y-4">
        <span className="font-bold text-slate-200 block uppercase">Regional Bed Allocation Matrix</span>
