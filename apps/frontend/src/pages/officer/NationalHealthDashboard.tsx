    ...
    <div className="space-y-6 max-w-7xl mx-auto px-4 font-mono text-xs text-slate-700">
      <div className="flex justify-between items-center border-b border-slate-200 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-sm font-bold text-slate-900 uppercase">National Health Intelligence Platform</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white border border-slate-200 shadow-sm p-5 rounded-xl border border-slate-200 text-center space-y-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white border border-slate-200 shadow-sm p-5 rounded-xl border border-slate-200 space-y-4">
          <span className="font-bold text-slate-800 block uppercase">State Health Rankings</span>
          <div className="h-48">
        ...
        <div className="bg-white border border-slate-200 shadow-sm p-5 rounded-xl border border-slate-200 space-y-4">
          <span className="font-bold text-slate-800 block uppercase">District Health Alerts</span>
