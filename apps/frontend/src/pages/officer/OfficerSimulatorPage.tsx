    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      <div className="flex items-center justify-between border-b border-slate-900 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold tracking-tight text-slate-100">Outbreak Scenario Simulator</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="glass-panel p-6 rounded-2xl border border-slate-900 space-y-5 lg:col-span-1 max-h-[700px] overflow-y-auto pr-3">
          <h3 className="text-xs font-mono font-bold tracking-wider text-slate-450 uppercase mb-4">Intervention Inputs</h3>
          ...
          {results && (
            <div className="glass-panel p-6 rounded-2xl border border-slate-900 space-y-4">
              <div className="flex items-center gap-2 border-b border-slate-850 pb-3">
                ...
                <h4 className="font-bold text-xs text-slate-200">AI Mitigation Recommendations</h4>
              </div>
          ...
          <div className="glass-panel p-6 rounded-2xl border border-slate-900">
            <form onSubmit={handleSave} className="flex flex-col sm:flex-row items-center gap-3">
              <input
                ...
                className="w-full px-4 py-2.5 rounded-lg bg-slate-900 border border-slate-850 text-xs outline-none text-slate-200 focus:border-teal-500/35"
              />
              <button
                type="submit"
